...
function printArray() {
	var msg = 'Sigue las instrucciones de mas abajo:\n'
	+ 'Contacto a Discord: Porro | Remiel Alecto en LEO\n\n'
	+ 'Pulsa click derecho en la zona del mapa que quieras añadir para colcar los puntos. Desactiva todas las opciones de zonas para poder realizar el click derecho sin darle a la capa de abajo. Rellena los valores "<edit here>" reemplazando solo en Title y Notes. Copia todo lo que esta debajo de "json y pasaselo a Discord: Porro. Si tu navegador no soporta copiar el texto de abajo, pulsa F12 o Ctrl+Shift+I para abrir la consola y copiarlo desde ahi. (Desliza abajo esta notificacion)\n\n';
	msg += '```json\n\t{\n\t\t"type": "Territories",'
	+ '\n\t\t"title": "<edit this>",'
	+ '\n\t\t"notes": "<edit this>",'
